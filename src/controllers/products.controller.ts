...
export const getAllProducts = (req:Request, res:Response, next:NextFunction):any => {
    try {
        res.status(200).json({ message: "Product list was successfully", products: [
            {
                id: 1,
        ...
        next(new Error("Error occured while getting all products :" + error.message))
    }
}
